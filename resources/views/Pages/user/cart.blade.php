                    ...
                    <table class="table text-nowrap">
                        ...
                        <tbody class="border-0">
                            ...
                            <tr class="produk-data">
                                <input type="hidden" class="prod-id" id="iniid" value="{{ $item->produk->id }}">
                                <th class="ps-0 py-3 border-light text-center" scope="row">
                                    <div class="d-flex align-items-center"><a
                                        ...
                                        <div class="ms-3"><strong class="h6"><a class="reset-anchor animsition-link"
                                                    href="{{ url('detail/' . $item->produk->id) }}">{{
                                                    $item->produk->namaProduk }}</a></strong>
                                        </div>
                                    </div>
                                </th>
                                ...
                                <td class="p-3 align-middle border-light">
                                    <div class="border d-flex align-items-center justify-content-between px-3">
                                        <div class="quantity">
                                            <button class="dec-btn p-0 ubahQuantity"><i class="fas fa-caret-left"></i></button>
                                            <input class="form-control form-control-sm border-0 shadow-0 p-0 qty-input" name="qty" type="text" value="{{ $item->kuantitas }}" />
                                            <button class="inc-btn p-0 ubahQuantity"><i class="fas fa-caret-right"></i></button>
                                        </div>
                                    </div>
                                </td>
                                <td class="p-3 align-middle border-light">
                    ...
                    <div class="card-body">
                        ...
                        <ul class="list-unstyled mb-0">
                            <li class="d-flex align-items-center justify-content-between mb-4"><strong
                                    class="text-uppercase small font-weight-bold">Total</strong><span id="total">{{
                                    'Rp.' . ' ' . number_format($total, 0, ',', '.') }}</span></li>
                            <li>
