          ...
          <div class="row">
            ...
            <div class="col-md-4">
              <a class="category-item mb-4" href="shop.html"
                ><img class="img-fluid" src={{ asset ("store/img/cat-img-2.jpg")}} alt="" /><strong
                  class="category-item-title"
                  >Shoes</strong
                ></a
              ><a class="category-item" href="shop.html"
                ><img class="img-fluid" src={{ asset ("store/img/cat-img-3.jpg")}} alt="" /><strong
                  class="category-item-title"
                  >Watches</strong
                ></a
              >
            ...
            <div class="col-md-4">
              <a class="category-item" href="shop.html"
                ><img class="img-fluid" src={{ asset ("store/img/cat-img-4.jpg")}} alt="" /><strong
                  class="category-item-title"
                  >Electronics</strong
                ></a
              >
              ...
              <div class="product text-center">
                <div class="position-relative mb-3">
                  ...
                  <a class="d-block" href="detail.html"
                    ><img
                      class="img-fluid w-100"
                      src={{ asset ("store/img/product-2.jpg")}}
                      alt="..."
                  /></a>
                  <div class="product-overlay">
                    <ul class="mb-0 list-inline">
              ...
              <div class="product text-center">
                <div class="position-relative mb-3">
                  ...
                  <a class="d-block" href="detail.html"
                    ><img
                      class="img-fluid w-100"
                      src={{ asset ("store/img/product-3.jpg")}}
                      alt="..."
                  /></a>
                  <div class="product-overlay">
                    <ul class="mb-0 list-inline">
              ...
              <div class="product text-center">
                <div class="position-relative mb-3">
                  ...
                  <a class="d-block" href="detail.html"
                    ><img
                      class="img-fluid w-100"
                      src={{ asset ("store/img/product-4.jpg")}}
                      alt="..."
                  /></a>
                  <div class="product-overlay">
                    <ul class="mb-0 list-inline">
              ...
              <div class="product text-center">
                <div class="position-relative mb-3">
                  ...
                  <a class="d-block" href="detail.html"
                    ><img
                      class="img-fluid w-100"
                      src={{ asset ("store/img/product-5.jpg")}}
                      alt="..."
                  /></a>
                  <div class="product-overlay">
                    <ul class="mb-0 list-inline">
              ...
              <div class="product text-center">
                <div class="position-relative mb-3">
                  ...
                  <a class="d-block" href="detail.html"
                    ><img
                      class="img-fluid w-100"
                      src={{ asset ("store/img/product-6.jpg")}}
                      alt="..."
                  /></a>
                  <div class="product-overlay">
                    <ul class="mb-0 list-inline">
              ...
              <div class="product text-center">
                <div class="position-relative mb-3">
                  ...
                  <a class="d-block" href="detail.html"
                    ><img
                      class="img-fluid w-100"
                      src={{ asset ("store/img/product-7.jpg")}}
                      alt="..."
                  /></a>
                  <div class="product-overlay">
                    <ul class="mb-0 list-inline">
              ...
              <div class="product text-center">
                <div class="position-relative mb-3">
                  ...
                  <a class="d-block" href="detail.html"
                    ><img
                      class="img-fluid w-100"
                      src={{ asset ("store/img/product-8.jpg")}}
                      alt="..."
                  /></a>
                  <div class="product-overlay">
                    <ul class="mb-0 list-inline">
